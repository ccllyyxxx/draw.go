# Documentos de Entrada (Business & Product Docs)

Coloca en esta carpeta (`docs/`) los archivos de producto, requerimientos de negocio, transcripciones o notas de reunión.

## Flujo de Trabajo (Docs -> Features -> Jira)
